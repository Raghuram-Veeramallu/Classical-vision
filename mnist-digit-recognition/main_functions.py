...
import numpy as np
from digit_recognition import get_mini_batch, fc, relu, conv, pool2x2, flattening
from digit_recognition import train_slp_linear, train_slp, train_mlp, train_cnn


def main_slp_linear():
    mnist_train = sio.loadmat('./mnist-digit-recognition/mnist_train.mat')
    mnist_test = sio.loadmat('./mnist-digit-recognition/mnist_test.mat')
    ...
    sio.savemat('./mnist-digit-recognition/slp_linear.mat', mdict={'w': w, 'b': b})
...
def main_slp():
    ...
    sio.savemat('./mnist-digit-recognition/slp.mat', mdict={'w': w, 'b': b})
...
def main_mlp():
    ...
    sio.savemat('./mnist-digit-recognition/mlp.mat', mdict={'w1': w1, 'b1': b1, 'w2': w2, 'b2': b2})
...
def main_cnn():
    ...
    sio.savemat('./mnist-digit-recognition/cnn.mat', mdict={'w_conv': w_conv, 'b_conv': b_conv, 'w_fc': w_fc, 'b_fc': b_fc})
